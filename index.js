...
btnEl.addEventListener("click", function () {
  ...
  if (inputElValue && inputFixedPriceElValue && inputCategoryElValue) {
    createElements(inputElValue, inputFixedPriceElValue, undefined, 0, false, 1, inputCategoryElValue);

    const newItem = {
      item: inputElValue,
      fixedPrice: inputFixedPriceElValue,
      category: inputCategoryElValue, // New field for category
...
const createElements = (
  ...
  // Create a label or div for the category
  ...
  listContainerDIV.appendChild(itemContainer);
   ...
   // Append the category label to the item container
